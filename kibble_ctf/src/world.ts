import { PlayerState, WorldOnAddPlayer, CustomState, WorldInit, Vec3 } from "../lib/hy";

const GUN_TYPE_ID = 1;
const SHOTGUN_TYPE_ID = 5;

export const init: WorldInit = (worldState: CustomState): CustomState => {
...
export const onAddPlayer: WorldOnAddPlayer = (
